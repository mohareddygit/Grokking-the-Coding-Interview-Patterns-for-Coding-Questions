...
//Warning: This is generally fine for Integer, but for very large numbers or Long, b - a can cause integer overflow, leading to incorrect sorting.
//PriorityQueue<Integer> maxHeap = new PriorityQueue<>(Collections.reverseOrder());Cleanest, most readable, and handles edge cases perfectly
//PriorityQueue<Integer> maxHeap = new PriorityQueue<>(Comparator.reverseOrder()); .. modern & robust
